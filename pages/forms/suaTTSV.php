  ...
  <aside class="main-sidebar sidebar-dark-teal elevation-4 cl">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="#" class="d-block" style="text-decoration: underline; color: rgb(255, 255, 255);">Tên sinh viên</a>
          </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="../examples/danhsachBaiDang.php" class="nav-link">
         ...
         <li class="nav-item">
            <a href="suaNV.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../tables/dsNV.php" class="nav-link">
...
<?php
  ...
  $tenDangNhap = $_SESSION['tenDangNhap'];
	if(isset($_POST['update_password'])){
		...
		$new_password = $_POST['mkmoi'];
		$confirm_password = $_POST['mkxacnhan'];
