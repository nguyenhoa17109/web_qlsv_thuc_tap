    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
            <a href="../../forms/themBV.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../pages/tables/dsSVĐK.php" class="nav-link">
...
<?php
	if(isset($_POST['update'])){
        ...
        echo "thao linh tinh";
          ...
          echo "<script>window.open('xembaiviet.php','_self')</script>";
		    }
  }
  $tenDangNhap = $_SESSION['tenDangNhap'];
	if(isset($_POST['update_password'])){
		...
		if($confirm_password != $new_password){
			...
			echo "<script>window.open('suaTTDN.php','_self')</script>";
		}
	}
?>