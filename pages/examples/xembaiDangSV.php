  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../../sinhVien.php" class="nav-link">Trang chủ</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-teal elevation-4 cl">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
            <a href="../forms/suaTTSV.php" class="d-block">Tên sinh viên</a>
          </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="../examples/danhsachBaiDang.php" class="nav-link active">
         ...
         <li class="nav-item">
            <a href="../forms/suaNV.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="../tables/xemHang.php" class="nav-link">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
              ...
              <?php
                ...
                echo "<a href='../../login.php' class='btn btn-success btn-black waves-effect z-depth-0' name='apply'>Đăng nhập</a>";
              }
