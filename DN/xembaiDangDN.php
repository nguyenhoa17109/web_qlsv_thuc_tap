  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 cl">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="pages/forms/suaTTDN.php" class="d-block">Tên doanh nghiệp</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
            <a href="pages/forms/themBV.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="pages/tables/dsViTriDN.php" class="nav-link">
