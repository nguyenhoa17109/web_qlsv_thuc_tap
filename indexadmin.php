...
<div class="wrapper">
  ...
  <aside class="main-sidebar cl sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index.html" class="brand-link cl">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h5 class="mb-2 mt-4">Tổng quan</h5>
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="Admin/BaiViet/thongKeBV.html" class="small-box-footer">
                Xem thêm <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <!-- end loading -->
              <div class="inner">
                <h3>900<sup style="font-size: 20px">lượt xem/ngày</sup></h3>
