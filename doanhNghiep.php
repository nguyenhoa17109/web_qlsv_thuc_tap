  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 cl">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="DN/suaTTDN.php" class="d-block">Tên doanh nghiệp</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="DN/dsSVDK.php" class="nav-link">
              <i class="nav-icon fas fa-table"></i>
              <p>Danh sách đăng kí</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="DN/dsViTriDN.php" class="nav-link">
          ...
          <?php while($row_baiviet = mysqli_fetch_assoc($baiviet)):?>
              <tr>
                ...
                <td class="project-state text-center">
                    <?php echo ($row_baiviet['trangthai'] == 1)? "<span class='badge badge-success'>Đã duyệt</span>": "<span class='badge badge-danger'>Đã duyệt</span>" ?>
                </td>
